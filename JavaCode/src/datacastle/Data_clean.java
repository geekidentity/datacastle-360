...
public class Data_clean {
	...
	public static void main(String[] argv) throws IOException {
		...
		// billPerBank(NewdataPath+"Good_New_bill_detail.txt",
		// NewdataPath+"Good_perBillBank1.txt");
		// billPerBank(NewdataPath+"Bad_New_bill_detail.txt",
		// NewdataPath+"Bad_perBillBank1.txt");

		// billPerBank(dataPath+"clean_bill_detail_train.txt",
		// NewdataPath+"cleanAgain_Train.txt");
		// billPerBank(testPath+"clean_bill_detail_test.txt",
		// NewdataPath+"cleanAgain_Test.txt");
	}
